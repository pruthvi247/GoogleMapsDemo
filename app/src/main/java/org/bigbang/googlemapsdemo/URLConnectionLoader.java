...
/**
 * Created by pruthvikumar on 20/3/18.
 */

public class URLConnectionLoader extends AsyncTaskLoader<String> {
    ...
    public URLConnectionLoader(Context context, String url) {
        super(context);
        this.url = url;
    }
