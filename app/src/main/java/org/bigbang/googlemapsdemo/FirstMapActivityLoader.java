...
/**
 * Created by pruthvikumar on 21/3/18.
 */

public class FirstMapActivityLoader extends AppCompatActivity implements OnMapReadyCallback,
        GoogleApiClient.OnConnectionFailedListener,LoaderManager.LoaderCallbacks<String> {
    ...
    private void geoLocate() {
        ...
        Geocoder geocoder = new Geocoder(FirstMapActivityLoader.this);
...
//            mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
    ...
    private void initMap() {
        ...
        mapFragment.getMapAsync(FirstMapActivityLoader.this);
...
//                            double lng = currentLocation.getLongitude();
                            ...
                            Toast.makeText(FirstMapActivityLoader.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
...
//                Log.d(TAG, "onResult: attributions: " + place.getAttributions());
    ...
    public Loader<String> onCreateLoader(int id, Bundle args) {
        return new URLConnectionLoader(this, url);
    }
    ...
    public void onLoadFinished(Loader<String> loader, String data) {
        ...
        if (!data.isEmpty()) {
            String[] latLangString = data.split(",");
            LatLng location = new LatLng(Double.parseDouble(latLangString[0]), Double.parseDouble(latLangString[1]));
            markPin(location, "Loader is not working");
        }
    }
